...
- Claude Code, Codex and Cursor discover the installed `/align` and `/impact` → [01-0010.0020](../tickets/01-0010.0020-live-alignment-across-hosts.md).
