...
- How denoise and sync-arch compose into `/maintain`, and what the first live close covers → [01-0010.0070](../tickets/01-0010.0070-install-maintain.md). Align was not finished this session.
