...
- A mechanism has three independent properties — **delivered, indexed, singly authored** — and a gap in any is declared with a ticket rather than left absent → [the spec](../spec/01-0011-mechanism-shape.md), first proved on [01-0011.0010](../tickets/01-0011.0010-mechanism-declared.md).
