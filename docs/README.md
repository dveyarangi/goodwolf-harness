...
- [Initial skills comparison](../audit-2026-09-05/REPORT.md): verified discrepancies between existing copies.
...
Since 2026-09-05 the harness lives at `D:\Dev\AI\agents`, this repository; the earlier working home `D:\Dev\AI\.agents` is retired. The installed skills are under [`.agents/skills`](../.agents/skills/), the pre-audit corpus under [`legacy/skills`](../legacy/skills/) as evidence.
