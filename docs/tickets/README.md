...
its align now owns. Nothing is implemented; the queue's *72 behavioral tests* moves when it is.
...
**Current stage:** [01-0011.0010](01-0011.0010-mechanism-declared.md) is planned and awaits
`/implement`, stage 1 of five in [its RFC](../rfc/01-0011.0010-mechanism-declared.md). Wake still
