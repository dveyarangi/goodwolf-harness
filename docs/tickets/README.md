...
**2026-09-07, `/plan` on [01-0011.0010](01-0011.0010-mechanism-declared.md).** Its RFC is
[written and validated once](../rfc/01-0011.0010-mechanism-declared.md): `/mechanism` plus a
...
[.0022](01-0011.0022-shape-survives-second-mechanism.md) — so the document's shedding is
...
**Current stage:** [01-0011.0022](01-0011.0022-shape-survives-second-mechanism.md) is
**implemented**, 2026-09-07, across all five stages of
[its RFC](../rfc/01-0011.0022-shape-survives-second-mechanism.md), and **awaits `/verify`**.
`/maintain` is declared; the check reports two declarations true and did not change to admit
the second; the body is rules A1–E3 with the interim dueness rule in a `<temporary>` block; the
evidence moved to `docs/mechanisms/`; `docs/process.md` shed *Mechanisms and skills*, *Tree
maintenance*, *Mechanical maintenance* and *Current documents and evidence*; 112 → 115 tests.
The ordering below records the align that preceded it. [01-0011.0010](01-0011.0010-mechanism-declared.md) was
...
| [A second mechanism is declared, and the shape holds or is amended](01-0011.0022-shape-survives-second-mechanism.md) | In progress (implemented 2026-09-07; awaits `/verify`) | HITL | `/maintain` is declared through the shape with its parts, its moments and its record obligation each carrying a state, the declaration passes the check `01-0011.0010` shipped, and what the second application breaks is amended in the shape rather than worked around in the declaration. |
