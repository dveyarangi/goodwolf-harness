...
| [A mechanism's shape is observed, not asserted](01-0011.0050-shape-checked.md) | Ready (aligned 2026-09-20) | AFK | A check reports, across every declared mechanism, each moment's instruction or its kind of absence, and every installed skill is either named by a mechanism or sits in an allowlist with its reason. |
