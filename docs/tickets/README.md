...
**`.0140` is planned, 2026-09-20** — [its RFC](../rfc/01-0010.0140-core-stands-alone.md) is
authored, the sixteen bare links are wrapped, and three choices wait on the user under the RFC's
*For the user*; **the candidate is `.0140`'s `/implement`**. [01-0020](01-0020-pacer.md)'s align opened 2026-09-20 on the wake
